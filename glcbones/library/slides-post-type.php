...
function slide_post_type() { 
    ...
    register_post_type( 'slides_type', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
        ...
        array( 'labels' => array(
            ...
            'description' => __( 'This is a slide to be used in a slideshow', 'bonestheme' ), /* Custom Type Description */
            'public' => true,
            ...
            'rewrite'   => array( 'slug' => 'slides_type', 'with_front' => false ), /* you can specify its url slug */
            'has_archive' => 'slides_type', /* you can rename the slug here */
    ...
    // register_taxonomy_for_object_type( 'category', 'slides_type' );
    /* this adds your post tags to your custom post type */
    // register_taxonomy_for_object_type( 'post_tag', 'slides_type' );
    ...
    */
    ...
    //     array('slides_type'), /* if you change the name of register_post_type( 'slides_type', then you have to change this */
